...
export default function Show({ medicine }) {
    return (
        <AuthenticatedLayout header={`Medicine: ${medicine.name}`}>
            <FlashMessage />
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <Link href={`/medicines/${medicine.id}/edit`} className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
