                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" id="test_date" value={data.test_date} onChange={(e) => setData('test_date', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required />
