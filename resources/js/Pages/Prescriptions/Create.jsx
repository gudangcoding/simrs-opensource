...
export default function Create({ patients, doctors, medicalRecords }) {
    ...
    return (
        <AuthenticatedLayout header="Add Prescription">
            <FlashMessage />
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="bg-white shadow rounded-lg p-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <Field label="Date" htmlFor="prescription_date" required>
                            <Input id="prescription_date" type="datetime-local" value={data.prescription_date} onChange={(e) => setData('prescription_date', e.target.value)} required error={errors.prescription_date} />
                        </Field>
